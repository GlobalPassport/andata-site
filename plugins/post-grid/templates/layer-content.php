...
//		$item['title_link'] = '<a target="'.$link_target.'" class="element element_'.$item_id.' '.$item_key.' '.$custom_class.'" href="'.$item_post_permalink.'">'.apply_filters('post_grid_filter_grid_item_title',wp_trim_words(get_the_title($item_post_id), $char_limit,''))
//            .'<div class="layer-media">'.$html_media.'</div></a>';


        $item['title_link'] = '<a  class="element element_'.$item_id.' '.$item_key.' '.$custom_class.'" href="'.$item_post_permalink.'">'.apply_filters('post_grid_filter_grid_item_title',wp_trim_words(get_the_title($item_post_id), $char_limit,''))
            .'<div class="layer-media">'.$html_media.'</div></a>';
