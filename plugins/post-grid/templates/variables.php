...
$nav_top_search_icon = isset($post_grid_meta_options['nav_top']['search_icon']) ? $post_grid_meta_options['nav_top']['search_icon'] : '<i class="fas fa-search"></i>';
	...
	*/
    ...
    $pagination_prev_text = __('<img src="'.get_template_directory_uri().'/assets/img/icon/prev_p.png">', 'post-grid');

    $pagination_next_text = __('<img src="'.get_template_directory_uri().'/assets/img/icon/next_p.png">', 'post-grid');
