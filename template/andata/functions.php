...
function enqueue_styles() {
    ...
    wp_register_style('style-grid', '/wp-content/plugins/post-grid/assets/frontend/css/style.css?ver=5.3.2');
...
//require_once get_parent_theme_file_path( '/inc/wa.php' );
